...
<div id="wrapper" class="toggled">
    ...
    <#--分页-->
        <div class="col-md-12 column">
            ...
            <#else>
                <li><a href="/supershop/seller/order/noPayList?pageIndex=${currentPage - 1}&pageSize=${size}">上一页</a></li>
            </#if>
            ...
            <#list 1..orderMasterPage.getTotalPages() as index>
                ...
                <#else>
                    <li><a href="/supershop/seller/order/noPayList?pageIndex=${index}&pageSize=${size}">${index}</a></li>
                </#if>
            </#list>
            ...
            <#else>
                <li><a href="/supershop/seller/order/noPayList?pageIndex=${currentPage + 1}&pageSize=${size}">下一页</a></li>
            </#if>
            </ul>
        </div>
</body>
